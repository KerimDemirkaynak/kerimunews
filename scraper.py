...
import json
import time
from xml.sax.saxutils import escape # XML hatalarını önlemek için
...
def rss_olustur(haberler):
    # Kendi RSS Beslememizi XML formatında üretiyoruz
    rss_items = ""
    for h in haberler:
        rss_items += f"""
        <item>
...
<channel>
    ...
    <link>https://github.com/KerimDemirkaynak</link>
    ...
    with open('rss.xml', 'w', encoding='utf-8') as f:
        f.write(rss_feed)
    print("RSS dosyası oluşturuldu: rss.xml")
